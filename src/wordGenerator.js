...
//  What this file does: It gives random words to the typing
//  test. You can pick easy, common or hard words. It also
//  makes sure the same word doesn't show up twice in a row.
// ============================================================


// These are all the words sorted by difficulty.
// Easy = small simple word 
// Common = everyday words
// Hard = complex words  that are tough to type.

const WORD_LISTS = {

  // Simple 3-4 letter words — for beginners
  easy: [
  ...
  // Words people use every day — the default mode for TypeShift
  common: [
  ...
  // Long and tricky words — for people who want a real challenge
  hard: [
    ...
    "whimsical", "zealous", "zeitgeist", "conscientious", "contemplative",
    "controversial", "disenfranchise", "idiosyncrasy", "imperceptible",
    "irreconcilable", "multifaceted", "philosophical", "transcendental",
    "abstemious", "acrimonious", "alacrity", "ameliorate", "anathema",
    "apotheosis", "approbation", "assiduous", "auspicious", "avarice",
    "benediction", "bombastic", "bourgeois", "capricious", "capitulate",
    "catharsis", "caustic", "chicanery", "churlish", "circumlocution",
    "clemency", "coalesce", "cogitate", "compunction", "conflagration",
    "consternation", "contentious", "contrite", "copious", "credulous",
    "culpable", "cupidity", "dearth", "debacle", "deference", "deleterious",
    "denouement", "depravity", "desolate", "didactic", "dilettante",
    "dissonance", "duplicitous", "ebullience", "efficacious", "effrontery",
    "egalitarian", "elucidation", "empirical", "enervate", "enigmatic",
    "equanimity", "erudite", "esoteric", "euphemism", "exorbitant",
    "expedient", "extravagant", "exuberant", "feckless", "fervent",
    "flagrant", "flippant", "fortuitous", "garrulous", "grandiloquent",
    "harangue", "hubris", "iconoclast", "ignominious", "immutable",
    "impassive", "impeccable", "imperturbable", "impudent", "incorrigible",
    "indolent", "ineffable", "inexorable", "ingenuous", "inimical",
    "innocuous", "insatiable", "intrepid", "invidious", "irascible",
    "laconic", "languid", "lethargic", "licentious", "listless",
    "lugubrious", "malfeasance", "malleable", "mendacious", "mercurial",
    "misanthrope", "mitigate", "mollify", "morose", "munificent",
    "myopic", "nebulous", "nefarious", "negligent", "obdurate",
    "obsequious", "obtuse", "ominous", "opprobrium", "ostracize",
    "palliate", "panacea", "parsimonious", "pedantic", "pernicious",
    "pertinacious", "petulant", "placate", "platitude", "plausible",
    "polemical", "pompous", "ponderous", "precarious", "precocious",
    "predilection", "preponderance", "pretentious", "probity", "proclivity",
    "profligate", "prolific", "provincial", "prudent", "pugnacious",
    "punctilious", "pusillanimous", "quixotic", "recondite", "redolent",
    "refractory", "reticent", "sanctimonious", "scrupulous", "seditious",
    "specious", "stultify", "subjugate", "supercilious", "sycophant",
    "taciturn", "temerity", "tendentious", "timorous", "torpid",
    "truculent", "turbulent", "tyrannical", "unctuous", "usurp",
    "utilitarian", "vapid", "vehement", "verbose", "vexatious",
    "vicissitude", "vilify", "virulent", "vitriolic", "vociferous",
  ],
};

// yaha pe i  used the [[[[[[[[[Fisher-Yates algorithm]]]]]]]]] here because it gives random results ek dum bina koi baise ke 
...
function generateFromCustomList(list, count = 30) {
  ...
  if (pool.length === 0) {
    throw new Error("TypeShift: No valid words found in the list after cleaning.");
  }
